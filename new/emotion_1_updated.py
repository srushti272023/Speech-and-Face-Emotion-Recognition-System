...
def files_count():
    ...
    if int(number_of_Happy_files) > int(number_of_Fear_files) and int(number_of_Happy_files) > int(number_of_sad_files) and int(number_of_Happy_files) > int(number_of_neutral_files) and int(number_of_Happy_files) > int(number_of_Surprised_files) :
        str_label="Stress Evaluation is = 10% and Person Was Excellent "
        print(str_label)
        ...
        str_label = "Stress Evaluation is = 25% and Person Was Good "
        print(str_label)
        ...
        str_label = "Stress Evaluation is = 75% and Person Was better but \n can't clear and understand concept "
        print(str_label)
        ...
        str_label = "Stress Evaluation is = 5% and Person Was Excellent"
        print(str_label)
