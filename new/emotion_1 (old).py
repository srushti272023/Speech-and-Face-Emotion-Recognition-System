...
def upload():
    ...
    cap = cv2.VideoCapture(0)  ####for system camera on
    while True:
...
def files_count():
    ...
    #print(number_of_neutral_files)
    E = "Surprised Person are = {0}".format(number_of_neutral_files)
    print(E)
    ...
    if int(number_of_Happy_files) > int(number_of_Fear_files) and int(number_of_Happy_files) > int(number_of_sad_files) and int(number_of_Happy_files) > int(number_of_neutral_files):
        str_label="Stress Evaluation is = 75% and Person Was Excellent "
        print(str_label)
        ...
        str_label = "Stress Evaluation is = 65% and Person Was Good "
        print(str_label)
        ...
        str_label = "Stress Evaluation is = 50% and Person Was Better "
        print(str_label)
        ...
        str_label = "Stress Evaluation is = 40% and Person Was better but can't clear and understand concept "
        print(str_label)
